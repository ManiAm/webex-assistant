...
from webexpythonsdk.models.cards import Colors, TextBlock, FontWeight, FontSize, Column, AdaptiveCard, ColumnSet, Text, Image, HorizontalAlignment
from webexpythonsdk.models.cards.actions import Submit

from formatting import quote_info
...
class EchoCommand(Command):
    ...
    def execute(self, message, attachment_actions, activity):
        ...
        submit = Submit(title="Submit", data={"callback_keyword": "echo_callback"})
