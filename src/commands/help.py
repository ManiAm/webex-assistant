...
from webexpythonsdk.models.cards import Colors, TextBlock, FontWeight, FontSize, Column, AdaptiveCard, ColumnSet, ImageSize, Image, Fact
from webexpythonsdk.models.cards.actions import Submit

from models.command import Command, COMMAND_KEYWORD_KEY
...
class HelpCommand(Command):
    ...
    def __init__(self, bot_name, bot_help_subtitle, bot_help_image, bot_help_image_size=ImageSize.SMALL, commands=None):
