...
from models.command import CALLBACK_KEYWORD_KEY, Command, COMMAND_KEYWORD_KEY
from models.response import Response
from webex_websocket_client import WebexWebsocketClient
...
class WebexBot(WebexWebsocketClient):
    ...
    def __init__(self,
        ...
        # A set of commands this bot listens to
        self.commands = set()
